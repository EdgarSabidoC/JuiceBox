...
'''
  ...
  def compose(self) -> ComposeResult:
    ...
    with Horizontal(classes="hcontainer") as hcontainer:
      ...
      with Vertical(classes="vcontainer1") as vcontainer1:
        ...
        with Vertical(classes="vinnercontainer") as vinnercontainer:
          ...
          with Horizontal(classes="hinnercontainer"):
            ...
            yield empty_space
            # Link de Github
            about_link = Link(text="github/EdgarSabidoC", url="https://github.com/EdgarSabidoC", classes="github-link")
      ...
      with Vertical(classes="vcontainer2") as vcontainer2:
        ...
        # System architecture
        self.SYSTEM_ARCH = Static(self.SYSTEM_ARCH, expand=True)
  ...
  async def on_option_list_option_selected(self, event: OptionList.OptionSelected) -> None:
    ...
    if prompt in screen_map:
      await self.push_screen(screen_map[prompt])
